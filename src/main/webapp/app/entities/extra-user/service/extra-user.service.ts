...
export class ExtraUserService {
  public resourceUrl = this.applicationConfigService.getEndpointFor('api/extra-users');
  ...
  protected convertDateFromClient(extraUser: IExtraUser): IExtraUser {
    return Object.assign({}, extraUser, {
      dateNaissance: extraUser.dateNaissance?.isValid() ? extraUser.dateNaissance.format(DATE_FORMAT) : undefined,
    });
  }
