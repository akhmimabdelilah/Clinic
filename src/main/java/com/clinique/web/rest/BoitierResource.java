...
import com.clinique.repository.BoitierRepository;
...
/**
 * REST controller for managing {@link com.clinique.domain.Boitier}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BoitierResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/boitiers/{id}", consumes = "application/merge-patch+json")
